...
1. Open **Posts → Add New** on matthummel.com.
2. Title / slug / excerpt / tags from the matching `*.meta.json`.
3. Categories: **Web Development** + **AI** (and **DEV.to** when you cross-post).
4. Block editor → **Code editor** → paste the `*.html` body.
5. Switch to visual, confirm gallery/media-text/ship-pipe validate.
6. Rank Math: focus keyphrase + meta description from meta JSON.
